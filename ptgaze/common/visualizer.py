...
class Visualizer:
    ...
    def draw_bbox(self,
        ...
        print(f'FPS: {fps}')
        cv2.putText(self.image, f'FPS: {fps}', tuple(int(bbox[0]), int(bbox[1])), cv2.FONT_HERSHEY_SIMPLEX, 0.9, color, 2)
    ...
    def draw_3d_line(self,
        ...
        cv2.arrowedLine(self.image, pt0, pt1, color, 10, cv2.LINE_AA, tipLength=0.3)                 
